...
public class EmployeePayrollServiceTest {
	...
	public void given3EmployeesWhenWrittenToFileShouldMatchNumberOfEmployeeEntries() {
		EmployeePayrollData[] arrayOfEmployees = { new EmployeePayrollData(1, "ABC", 100.0),
				new EmployeePayrollData(2, "DEF", 200.0), new EmployeePayrollData(3, "GHI", 300.0) };
	...
	public void givenEmpDataInFileShouldRead() {
		...
		empPayrollService.readEmployeePayrollData(EmployeePayrollService.IOService.FILE_IO);
